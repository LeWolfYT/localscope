...
async def repeatWeather():
    while True:
        await asyncio.sleep(60)
        asyncio.create_task(refreshWeather())

print("making timer later")
...
print("weather thread starting later")
...
pg.event.pump()
async def main():
    asyncio.create_task(getWeather())
    await asyncio.sleep(0)
    asyncio.create_task(repeatWeather())
    await asyncio.sleep(0)
